...
function Footer() {
  ...
  if (location.pathname === '/itis3135/crappy-page') return null;
  ...
  return (
    <footer>
      ...
      <p>Running on: <a href="https://itis3135-react.vercel.app/" target="_blank" rel="noopener noreferrer">ITIS3135@Vercel</a></p>
    </footer>
  );
}
